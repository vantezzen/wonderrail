...
function StatusBar() {
  ...
  return (
    <div className="w-full py-3 px-12 dark:bg-zinc-900 bg-zinc-200 lg:absolute bottom-0 left-0 flex flex-col lg:flex-row gap-3 lg:gap-6 xl:gap-12 overflow-x-hidden">
